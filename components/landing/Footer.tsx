      ...
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
          ...
          <nav aria-label="Navegação do rodapé" className="flex flex-wrap justify-center gap-6 text-sm text-[#4B5563]">
            ...
            <Link href="/contact" className="hover:text-[#111827]">
              Contato
            </Link>
        ...
        <div className="mt-6 flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
          <p className="text-xs text-[#4B5563]">
            &copy; {new Date().getFullYear()} CrescitechMD. Todos os direitos
            reservados.
          </p>
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              aria-label="WhatsApp"
              className="text-[#4B5563] hover:text-[#25D366]"
            >
            ...
            {/* LinkedIn */}
            <a
              href="https://linkedin.com/company/crescitech"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="text-[#4B5563] hover:text-[#0A66C2]"
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Email */}
            <a
              href="mailto:contato@crescitechmd.com"
              aria-label="Email"
